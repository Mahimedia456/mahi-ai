...
import { Sparkles, Wand2, ScanSearch, ArrowUpCircle, History } from "lucide-react";
import { ImageEditorProvider } from "../context/ImageEditorContext.jsx";

const navItems = [
  { label: "Home", to: "home", icon: Sparkles },
  { label: "Magic Tools", to: "magic-tools", icon: Wand2 },
  { label: "Generative Fill", to: "generative-fill", icon: ScanSearch },
  { label: "Upscale", to: "upscale", icon: ArrowUpCircle },
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm text-white/40">
                  Upload once, then move between fill, cleanup, replacement, and enhancement without leaving the editor flow.
                </p>
              </div>
