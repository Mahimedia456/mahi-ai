...
import { reportedContent } from "../data/contentData";
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="grid grid-cols-1 gap-5 md:grid-cols-3">
        <ContentStatCard title="Reported Items" value={reportedContent.length} hint="Flagged for admin review" />
        <ContentStatCard title="Manual Review" value={reportedContent.length} hint="Pending moderation pass" />
        <ContentStatCard title="High Risk Users" value="1" hint="Accounts with repeated suspicious behavior" />
      </section>

      <ContentTable data={reportedContent} />
    </div>
  );
}